...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.cache/wt [current_project]
  set_property parent.project_path C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.xpr [current_project]
  set_property ip_repo_paths {
  C:/College/Thesis/vivado-library-master
  C:/Xilinx/Vivado/MyProjects/myIps
} [current_project]
  set_property ip_output_repo C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.srcs/sources_1/bd/design_1/design_1.bd
  set_property is_locked true [get_files C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.srcs/sources_1/bd/design_1/design_1.bd]
  set_param project.isImplRun false
  read_xdc C:/Xilinx/Vivado/MyProjects/PMOD_WIFI_OLD/PMOD_WIFI.srcs/constrs_1/imports/LED/nexys4.xdc
  set_param project.isImplRun true
