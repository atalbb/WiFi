...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/WiFi_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WiFi_lmb_bram_0.tcl
