...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/WiFi_axi_quad_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_axi_quad_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WiFi_axi_quad_spi_0_0.tcl
