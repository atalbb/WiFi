...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/WiFi_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WiFi_xbar_1.tcl
