...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WiFi_wrapper.tcl -notrace
