...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/WiFi_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WiFi_microblaze_0_axi_intc_0.tcl
