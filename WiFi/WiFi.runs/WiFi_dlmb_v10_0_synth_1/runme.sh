...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/WiFi_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WiFi_dlmb_v10_0.tcl
