...
HD_PWD='C:/College/Thesis/VivadoProjects/WiFi/WiFi/WiFi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WiFi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WiFi_wrapper.tcl
