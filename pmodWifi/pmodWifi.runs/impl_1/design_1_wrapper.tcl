...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Xilinx/Vivado/PMOD_WIFI_OLD/pmodWifi/pmodWifi.cache/wt [current_project]
  set_property parent.project_path C:/Xilinx/Vivado/PMOD_WIFI_OLD/pmodWifi/pmodWifi.xpr [current_project]
  set_property ip_repo_paths {{C:/Vivado Projects/vivado-library-master}} [current_project]
  set_property ip_output_repo C:/Xilinx/Vivado/PMOD_WIFI_OLD/pmodWifi/pmodWifi.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet C:/Xilinx/Vivado/PMOD_WIFI_OLD/pmodWifi/pmodWifi.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/Xilinx/Vivado/PMOD_WIFI_OLD/pmodWifi/pmodWifi.srcs/sources_1/bd/design_1/design_1.bd
  set_property is_locked true [get_files C:/Xilinx/Vivado/PMOD_WIFI_OLD/pmodWifi/pmodWifi.srcs/sources_1/bd/design_1/design_1.bd]
