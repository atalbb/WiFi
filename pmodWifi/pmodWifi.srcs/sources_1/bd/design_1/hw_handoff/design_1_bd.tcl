...
proc create_root_design { parentCell } {
  ...
  set axi_gpio_led [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 axi_gpio_led ]
  set axi_gpio_sw [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 axi_gpio_sw ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports axi_gpio_led] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports rgb_led] [get_bd_intf_pins axi_gpio_0/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports axi_gpio_sw] [get_bd_intf_pins axi_gpio_1/GPIO]
